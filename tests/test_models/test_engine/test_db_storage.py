...
class TestDBStorage(unittest.TestCase):
    ...
    def test_save(self):
        ...
        db = MySQLdb.connect(user="hbnb_test",
                             ...
                             db="hbnb_test_db")
        cursor = db.cursor()
        cursor.execute("SELECT * FROM states WHERE BINARY name = 'Washington'")
